...
2. Click the big green "Code" button in the top right of the page, then click "[Download ZIP](https://github.com/milaan9/Python_Decision_Tree_and_Random_Forest/archive/refs/heads/main.zip)".
